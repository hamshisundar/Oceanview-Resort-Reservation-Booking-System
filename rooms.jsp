  ...
  <main class="container section">
    <form id="filters-form" class="filters-bar" method="get" action="${pageContext.request.contextPath}/rooms">
      ...
      <div class="filter-group">
        ...
        <input type="number" id="min-price" name="minPrice" min="0" step="10" placeholder="0" value="${param.minPrice}">
      </div>
      <div class="filter-group">
        <label for="max-price">Max price ($)</label>
        <input type="number" id="max-price" name="maxPrice" min="0" step="10" placeholder="500" value="${param.maxPrice}">
      </div>
      <div class="filter-group">
