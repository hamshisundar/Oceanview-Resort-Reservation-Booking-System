  ...
  <main class="container section">
    ...
    <div class="stats-grid">
      ...
      <div class="stat-card">
        ...
        <p class="value">Rs. <fmt:formatNumber value="${revenueThisMonth}" type="number" maxFractionDigits="0" groupingUsed="true"/></p>
      </div>
      <div class="stat-card">
    ...
    <p><a href="${pageContext.request.contextPath}/admin/rooms" class="btn">Manage Rooms</a>
       <a href="${pageContext.request.contextPath}/admin/bookings" class="btn" style="margin-left: 0.5rem;">Manage Bookings</a>
       <a href="${pageContext.request.contextPath}/admin/reports" class="btn" style="margin-left: 0.5rem;">View Reports</a></p>
  </main>

  <footer class="footer">
    <div class="footer-inner">
      <div><h4>Ocean View Resort</h4><p>Admin panel</p></div>
    </div>
